                ...
                <div class="row pt--80 pt-md--60 pt-sm--35 pb--40 pb-md--30 pb-sm--15">
                    <div class="col-lg-7 col-md-6 mb-sm--30">
                        <div class="about-text">
                            ...
                            <figure>
                                <img src="{{ asset('frontend_assets') }}/img/about/about-signature.png" alt="signature">
                            </figure>
                        </div>
                    </div>
                    <div class="col-lg-5 col-md-6">
                        <figure>
                            <img src="{{ asset('frontend_assets') }}/img/about/about-bg2.jpg" alt="about">
                        </figure>
                    </div>
                </div>
                    ...
                    <div class="col-lg-5 col-md-6 order-md-1">
                        <figure class="image-box image-box-w-video-btn btn-right max-w-sm-65 max-w-xs-100">
                            <a href="https://www.youtube.com/watch?v=Rp19QD2XIGM" class="video-popup">
                                <img src="{{ asset('frontend_assets') }}/img/about/about-bg3.jpg" alt="about">
                            ...
                            <div class="col-12">
                                <div class="airi-element-carousel team-carousel"
                                    ...
                                    <div class="airi-team">
                                        <div class="team-member">
                                            <div class="team-member__thumbnail">
                                                <img src="{{ asset('frontend_assets') }}/img/team/member-1.jpg" alt="Team Member">
                                    ...
                                    <div class="airi-team">
                                        <div class="team-member">
                                            <div class="team-member__thumbnail">
                                                <img src="{{ asset('frontend_assets') }}/img/team/member-2.jpg" alt="Team Member">
                                                <a href="team.html" class="link-overlay">Team member</a>
                                                <div class="team-member__overlay">
                                                    <ul class="social social-round">
                                                        <li class="social__item">
                                    ...
                                    <div class="airi-team">
                                        <div class="team-member">
                                            <div class="team-member__thumbnail">
                                                <img src="{{ asset('frontend_assets') }}/img/team/member-3.jpg" alt="Team Member">
                                                <a href="team.html" class="link-overlay">Team member</a>
                                                <div class="team-member__overlay">
                                                    <ul class="social social-round">
                                                        <li class="social__item">
                                    ...
                                    <div class="airi-team">
                                        <div class="team-member">
                                            <div class="team-member__thumbnail">
                                                <img src="{{ asset('frontend_assets') }}/img/team/member-4.jpg" alt="Team Member">
                                                <a href="team.html" class="link-overlay">Team member</a>
                                                <div class="team-member__overlay">
                                                    <ul class="social social-round">
                                                        <li class="social__item">
                                    ...
                                    <div class="airi-team">
                                        <div class="team-member">
                                            <div class="team-member__thumbnail">
                                                <img src="{{ asset('frontend_assets') }}/img/team/member-5.jpg" alt="Team Member">
                                                <a href="team.html" class="link-overlay">Team member</a>
                                                <div class="team-member__overlay">
                                                    <ul class="social social-round">
                                                        <li class="social__item">
                                    ...
                                    <div class="airi-team">
                                        <div class="team-member">
                                            <div class="team-member__thumbnail">
                                                <img src="{{ asset('frontend_assets') }}/img/team/member-6.jpg" alt="Team Member">
                                                <a href="team.html" class="link-overlay">Team member</a>
                                                <div class="team-member__overlay">
                                                    <ul class="social social-round">
                                                        <li class="social__item">
                                ...
                                <div class="airi-element-carousel testimonial-carousel"
                                    ...
                                    <div class="testimonial testimonial-style-3">
                                        <div class="testimonial__inner">
                                            <img src="{{ asset('frontend_assets') }}/img/others/happy-client-1.jpg" alt="Client"
                                    ...
                                    <div class="testimonial testimonial-style-3">
                                        <div class="testimonial__inner">
                                            <img src="{{ asset('frontend_assets') }}/img/others/happy-client-2.jpg" alt="Client"
                                                class="testimonial__author--img">
                                            <p class="testimonial__desc">"Maecenas eu accumsan libero. Fusce id
                                                imperdiet felis. Cras sed ex vel turpis ultricies blandit nec et
                                                massa. Pellentesque lectus turpis, vestibulum eu interdum vel.</p>
