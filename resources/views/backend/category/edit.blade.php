                            ...
                            <div class="card-body">
                                ...
                                <form class="theme-form theme-form-2 mega-form" action="{{ route('category.update',$category->id) }}"
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control" name="category_details" rows="6">{{ $category->category_details }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="form-group col-sm-9">
                                            <button type="submit" class="btn btn-animation">Update Category</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
