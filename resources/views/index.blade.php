                ...
                <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.7">
                    <ul>
                        ...
                        <li data-index="rs-1" data-transition="fade,random-premium" data-slotamount="default,default"
                            ...
                            data-thumb="{{ asset('frontend_assets') }}/img/slider/home-01/100x50_m1-s1-1.jpg"
                            ...
                            <div class="tp-caption     rev_group" id="slide-1-layer-1"
                                ...
                                <div class="tp-caption   tp-resizeme" id="slide-1-layer-3"
                                    ...
                                    <img src="{{ asset('frontend_assets') }}/img/slider/home-01/m1-s1-1-1.png"
                        ...
                        <li data-index="rs-2" data-transition="random-premium" data-slotamount="default"
                            ...
                            data-thumb="{{ asset('frontend_assets') }}/img/slider/home-01/100x50_m1-s1-2.jpg"
                        ...
                        <li data-index="rs-3" data-transition="random-premium" data-slotamount="default"
                            data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default"
                            data-easeout="default" data-masterspeed="default"
                            data-thumb="{{ asset('frontend_assets') }}/img/slider/home-01/100x50_m1-s1-3.jpg"
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="airi-element-carousel partner-carousel"
                            ...
                            <div class="item">
                                <div class="single-partner">
                                    <img src="{{ asset('frontend_assets') }}/img/partner/logo-partner2.png"
                                        alt="Partner">
                                </div>
                            </div>
                            <div class="item">
                                <div class="single-partner">
                                    <img src="{{ asset('frontend_assets') }}/img/partner/logo-partner3.png"
                                        alt="Partner">
                                </div>
                            </div>
                            <div class="item">
                                <div class="single-partner">
                                    <img src="{{ asset('frontend_assets') }}/img/partner/logo-partner4.png"
                                        alt="Partner">
                                </div>
                            </div>
                            <div class="item">
                                <div class="single-partner">
                                    <img src="{{ asset('frontend_assets') }}/img/partner/logo-partner5.png"
                                        alt="Partner">
                                </div>
                            </div>
                            <div class="item">
                                <div class="single-partner">
                                    <img src="{{ asset('frontend_assets') }}/img/partner/logo-partner6.png"
                                        alt="Partner">
                                </div>
                            </div>
                            <div class="item">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="banner-box banner-type-1 banner-hover-1 mb--20 mb-md--10 mb-sm--30">
                                    <div class="banner-inner">
                                        <div class="banner-image">
                                            <img src="{{ asset('frontend_assets') }}/img/banner/m01-collection1.jpg"
                                                alt="Banner">
                                        </div>
                                ...
                                <div class="banner-box banner-type-1 banner-hover-1 mb-sm--30">
                                    <div class="banner-inner">
                                        <div class="banner-image">
                                            <img src="{{ asset('frontend_assets') }}/img/banner/m01-collection2.jpg"
                                                alt="Banner">
                                        </div>
                                        <div class="banner-info">
                                            <a class="banner-btn" href="shop-sidebar.html">Shop Now</a>
                            ...
                            <div class="col-md-6">
                                <div class="banner-box banner-type-1 banner-hover-1">
                                    <div class="banner-inner">
                                        <div class="banner-image">
                                            <img src="{{ asset('frontend_assets') }}/img/banner/m01-collection3.jpg"
                                                alt="Banner">
                                        </div>
                                        <div class="banner-info">
                                            <a class="banner-btn" href="shop-sidebar.html">Shop Now</a>
